...
public class GM_Pagination {
    ...
    public GM_Pagination(Word[] m, int tamMem, int tamPagina) {
        this.m = m;
        this.tamMem = tamMem;
    ...
    public void desalocaPagina(PCB_B pcbBProcesso) {
        int[] paginas = pcbBProcesso.getFrames();
    ...
    public int traduzEnderecoFisico(PCB_B programa, int enderecoLogicoPrograma) {// função que traduz para o enederço físico da memória
    ...
    public void dumpPagina(PCB_B programa){
