...
public class Programas {
    public static Word[] fatorial = new Word[]{
    ...
    public static Word[] fibonacciTRAP = new Word[]{ // mesmo que prog exemplo, so que usa r0 no lugar de r8
    ...
    public static Word[] testeLeitura = new Word[]{
    ...
    public static Word[] testeEscrita = new Word[]{
            new Word(Opcode.LDI, 0, -1, 999),
            new Word(Opcode.STD, 0, -1, 10),
    ...
    public static Word[] fatorialTeste = new Word[]{
            // este fatorial so aceita valores positivos. nao pode ser zero
            // linha coment
    ...
    public static Word[] fatorialTesteEndereco = new Word[]{
    ...
    public static Word[] TestandoOverflow = new Word[]{
    ...
    public static Word[] TestandoOverflowParam = new Word[]{
