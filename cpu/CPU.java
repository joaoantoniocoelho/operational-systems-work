...
//    private SysCallHandling sysCall; // significa desvio para tratamento de chamadas de sistema - trap
    ...
    public CPU(Memory mem, int tamParticao, InterruptHandling _ih, SysCallHandling _sysCall) {
        super(mem, _ih,_sysCall); // ref a MEMORIA e
        // interrupt handler
        // passada na
        // criacao da CPU
    ...
    @Override
    public void setContext(int _base, int _limite, int _pc, int[] paginasProcesso) {
